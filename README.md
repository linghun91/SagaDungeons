...
│   ├── CommandRewardManageGUI.java (命令奖励管理GUI)
│   ├── CompositeConditionManageGUI.java (组合条件管理GUI)
│   ├── CompositeConditionTypeSelectionGUI.java (组合条件类型选择GUI)
│   ├── DungeonManageGUI.java (副本管理GUI)
│   ├── GUIManager.java (GUI管理器)
│   ├── ItemBuilder.java (物品构建器)
│   ├── ItemConditionManageGUI.java (物品条件管理GUI)
│   ├── ItemRewardManageGUI.java (物品奖励管理GUI)
...
│   ├── TemplateConditionsEditGUI.java (模板创建条件编辑GUI)
│   ├── TemplateEditMainGUI.java (模板编辑主GUI)
│   ├── TemplateRewardsEditGUI.java (模板奖励编辑GUI)
│   ├── TemplateSelectGUI.java (模板选择GUI)
│   ├── TemplateSpawnersEditGUI.java (模板刷怪点编辑GUI)
│   └── TimeRewardManageGUI.java (时间奖励管理GUI)
├── hook (插件集成)
